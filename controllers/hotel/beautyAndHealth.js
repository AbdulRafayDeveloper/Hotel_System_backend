...
const beautyAndHealth = require('../../models/hotels/beautyAndHealth');
...
Router.add = async (req, res) => {
    try {
        ...
        const data = new beautyAndHealth({ label });
        await data.save();
...
Router.delete = async (req, res) => {
    try {
        ...
        const result = await beautyAndHealth.findByIdAndDelete(id);
        if (result) {
